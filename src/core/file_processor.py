...
class FileProcessor:
    ...
    def generate_uuid_filename(self, original_filename: str) -> str:
    ...
    async def process_file(self, content: bytes, original_filename: str, kb_name: str) -> Tuple[str, str, str]:
